...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"9b0000","BackgroundColor":"141414","OutlineColor":"323232"}') },
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddToggle('RainbowAccent', {Text = 'Rainbow Accent (Buggy)',Default = self.Library.RainbowAccent, });
